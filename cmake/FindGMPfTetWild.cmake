...
find_path(GMP_INCLUDE_DIRS NAMES gmp.h PATHS ${GMP_INC} ${GMP_WINDOWS_PATH})
find_library(GMP_LIBRARIES NAMES gmp libgmp PATHS ${GMP_LIB} ${GMP_WINDOWS_PATH})
find_library(GMPXX_LIBRARIES NAMES gmpxx libgmpxx PATHS ${GMP_LIB} ${GMP_WINDOWS_PATH})
